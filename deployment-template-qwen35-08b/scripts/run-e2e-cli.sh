...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    --sku)
      case "$2" in
        Standard_NC24ads_A100_v4) E2E_SKUS_ARG+=("a100") ;;
        Standard_NC40ads_H100_v5) E2E_SKUS_ARG+=("h100") ;;
        *) echo "[ERROR] Unknown SKU: $2"; echo "  Supported: Standard_NC24ads_A100_v4, Standard_NC40ads_H100_v5"; exit 1 ;;
      esac
      shift 2 ;;
